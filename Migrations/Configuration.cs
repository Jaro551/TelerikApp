namespace SimpleTelerikApp.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SimpleTelerikApp.Data.FilmsContext>
    {
        ...
        protected override void Seed(SimpleTelerikApp.Data.FilmsContext context)
        {
            ...
            films.ForEach(s => context.Films.AddOrUpdate(p => p.Title, s));
            context.SaveChanges();
        }
    }
}
